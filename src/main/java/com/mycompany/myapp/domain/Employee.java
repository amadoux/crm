...
public class Employee implements Serializable {
    ...
    public Language getNationality() {
        return this.nationality;
    }

    public Employee nationality(Language nationality) {
        this.setNationality(nationality);
        return this;
    }

    public void setNationality(Language nationality) {
    ...
    public Employee releaseDate(ZonedDateTime releaseDate) {
