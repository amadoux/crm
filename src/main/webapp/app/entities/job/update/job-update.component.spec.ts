...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 26470 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 31791 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 11458 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 17133 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 32758 };
      job.tasks = [task];
      const employee: IEmployee = { id: 30053 };
      job.employee = employee;
