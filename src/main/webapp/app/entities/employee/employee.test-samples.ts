...
export const sampleWithPartialData: IEmployee = {
  ...
  birthDate: dayjs('2024-01-17T07:01'),
  entryDate: dayjs('2024-01-17T03:16'),
  workstation: 'till',
...
export const sampleWithFullData: IEmployee = {
  ...
  birthDate: dayjs('2024-01-17T07:52'),
  birthPlace: 'pounding dimly',
  entryDate: dayjs('2024-01-16T12:33'),
  releaseDate: dayjs('2024-01-16T12:58'),
  ...
  salaryType: 'NON_EXECUTIVE_SALARIED',
  hireDate: dayjs('2024-01-17T05:22'),
};
