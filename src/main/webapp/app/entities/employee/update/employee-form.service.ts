...
type EmployeeFormGroupContent = {
  ...
  workstation: FormControl<EmployeeFormRawValue['workstation']>;
  descriptionWorkstation: FormControl<EmployeeFormRawValue['descriptionWorkstation']>;
  level: FormControl<EmployeeFormRawValue['level']>;
  coefficient: FormControl<EmployeeFormRawValue['coefficient']>;
  employedManager: FormControl<EmployeeFormRawValue['employedManager']>;
  numberHours: FormControl<EmployeeFormRawValue['numberHours']>;
  averageHourlyCost: FormControl<EmployeeFormRawValue['averageHourlyCost']>;
  monthlyGrossAmount: FormControl<EmployeeFormRawValue['monthlyGrossAmount']>;
  commissionAmount: FormControl<EmployeeFormRawValue['commissionAmount']>;
  contractType: FormControl<EmployeeFormRawValue['contractType']>;
  salaryType: FormControl<EmployeeFormRawValue['salaryType']>;
  hireDate: FormControl<EmployeeFormRawValue['hireDate']>;
  enterprise: FormControl<EmployeeFormRawValue['enterprise']>;
...
export class EmployeeFormService {
  createEmployeeFormGroup(employee: EmployeeFormGroupInput = { id: null }): EmployeeFormGroup {
    ...
    return new FormGroup<EmployeeFormGroupContent>({
      ...
      workstation: new FormControl(employeeRawValue.workstation),
      descriptionWorkstation: new FormControl(employeeRawValue.descriptionWorkstation),
      level: new FormControl(employeeRawValue.level),
      coefficient: new FormControl(employeeRawValue.coefficient),
      employedManager: new FormControl(employeeRawValue.employedManager),
      numberHours: new FormControl(employeeRawValue.numberHours),
      averageHourlyCost: new FormControl(employeeRawValue.averageHourlyCost),
      monthlyGrossAmount: new FormControl(employeeRawValue.monthlyGrossAmount),
      commissionAmount: new FormControl(employeeRawValue.commissionAmount),
      contractType: new FormControl(employeeRawValue.contractType),
      salaryType: new FormControl(employeeRawValue.salaryType),
      hireDate: new FormControl(employeeRawValue.hireDate),
      enterprise: new FormControl(employeeRawValue.enterprise),
