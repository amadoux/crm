 ...
 */
type FormValueOf<T extends IEmployee | NewEmployee> = Omit<T, 'hireDate' | 'birthDate' | 'entryDate' | 'releaseDate'> & {
...
type EmployeeFormDefaults = Pick<NewEmployee, 'id' | 'hireDate' | 'birthDate' | 'entryDate' | 'releaseDate'>;
