...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 10179 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 17948 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 11332 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 991 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 24834 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 30704 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 19884 };
      jobHistory.job = job;
      const department: IDepartment = { id: 4206 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 21908 };
      jobHistory.employee = employee;
