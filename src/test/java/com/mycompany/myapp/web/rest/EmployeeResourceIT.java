...
class EmployeeResourceIT {
    ...
    private static final Pays DEFAULT_PAYS = Pays.CAMEROON;
    private static final Pays UPDATED_PAYS = Pays.SENEGAL;
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getPays()).isEqualTo(DEFAULT_PAYS);
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        assertThat(testEmployee.getPays()).isEqualTo(UPDATED_PAYS);
    }
